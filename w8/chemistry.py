#do i need to import pytest? approx?

def main():
    # Get a chemical formula for a molecule from the user.
    formula = input("What is the chemical formula? ")
    # Get the mass of a chemical sample in grams from the user.
    sample_mass = float(input("What is the mass of the chemical sample? (in grams) "))
    ...
    num_moles = sample_mass/molar_mass
    # Print the molar mass.
    
    print(f"The moler mass is: ", molar_mass)
    # Print the number of moles.
    print(f"The number of moles is: ", num_moles) #(how do I make it 6 digits? :.6f?)

    protons = sum_protons(symbol_quantity_list, periodic_table_dict)
    print(f"The total number of protons is: ", protons)
...
"""    symbol = 0
    ...
    for inner_list in periodic_table_list:
        print(inner_list[1], inner_list[2])"""
        

def make_periodic_table():
    periodic_table_dictionary = { # [symbol, name, automic_mass]
    "Ac":	["Actinium",	227],
    "Ag":	["Silver",	107.8682],
    ...
    return periodic_table_dictionary
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for list in symbol_quantity_list:
        ...
        value_of_key = periodic_table_dict[symbol]
        atomic_mass = value_of_key[ATOMIC_MASS_INDEX]
