...
def main():
    ...
    frm_main.master.title("Find the Area")
...
def populate_main_window(frm_main):
    ...
    ent_width = nent.IntEntry(frm_main, 12, 90, width=5)
    ent_height = nent.IntEntry(frm_main, 16, 90, width=5)
    ...
    lbl_height.grid(  row=0, column=2, padx=(30,3), pady=3)
    ent_height.grid(  row=0, column=3, padx=(30,3), pady=3)

    #lbl_slow.grid( row=0, column=3, padx=3, pady=3)
    #lbl_fast.grid( row=0, column=4, padx=3, pady=3)
    lbl_area.grid( row=0, column=4, padx=3, pady=3)
    ent_area.grid( row=0, column=5, padx=3, pady=3)
